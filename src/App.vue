...
const onSubmit = (result) => {
  // console.log(result);
  try {
    const url = `https://api.mapbox.com/search/searchbox/v1/retrieve/dXJuOm1ieHBvaTo3ZWIyMWE0ZS1jZGYzLTQxNGUtYjJhNy02ZDFmOWE3YzdiNDA?session_token=0f206044-3a78-42e1-8913-383ccd20b30b&access_token=pk.eyJ1IjoibWx2cmtobiIsImEiOiJjbHpsbzkzanMwM2kyMnJwbmo1dnhkZTlkIn0.eYXg3LX3YBuBLcY0Q6gMIQ`;
    return new Promise((resolve) => {
      fetch(url)
        .then((response) => response.json())
        .then((data) => {
